...
const Subscribe = () => {
  return (
    <div className="max-w-[400px] p-4 flex flex-col gap-4">
      ...
      <form action="https://viditor.lemonsqueezy.com/email-subscribe/external" method="post">
        <div className="w-80 flex flex-row items-center gap-x-2 ring-2 ring-blue-950 ring-offset-2 ring-offset-slate-950 rounded-xl bg-slate-900">
          <input className="w-[275px] h-10 bg-slate-900 px-4 rounded-xl" placeholder="youremail@domain.com" type="email" name="email" id="email" required></input>
          <button type="submit" className="w-7 h-7 flex-center ring-1 ring-slate-800 rounded-lg"><GrSend /></button>
        </div>
      </form>
    </div>
  )
